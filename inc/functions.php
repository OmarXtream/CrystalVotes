...
function caldiscount($price,$dis = 0){
 $myNumber = $price;
...
function getRank(int $id){
	...
	if($stmt->rowCount() !== 0){
		...
		$ranks=array(0 => array('عضو' => 'PRIMARY'), 1 => array('الدعم الفني' => 'SUCCESS'),  4 => array('اداري' => 'DANGER'), 5 => array('إداري' => 'DANGER'));
